...
-- 4. Orders va Customers – mijoz nomi + OrderID
...
SELECT P.PaymentID, O.OrderID, P.Amount AS PaidAmount, (O.Quantity * PR.Price) AS ExpectedAmount
FROM Payments P
...
SELECT E.Name AS Employee, M.Name AS Manager, E.Salary, M.Salary AS ManagerSalary
FROM Employees E
