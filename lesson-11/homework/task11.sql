...
WHERE D.DepartmentName IN ('Human Resources', 'Finance')
   OR (
       (CASE WHEN LOWER(E.Name) LIKE '%a%' THEN 1 ELSE 0 END) +
       (CASE WHEN LOWER(E.Name) LIKE '%e%' THEN 1 ELSE 0 END) +
       (CASE WHEN LOWER(E.Name) LIKE '%i%' THEN 1 ELSE 0 END) +
       (CASE WHEN LOWER(E.Name) LIKE '%o%' THEN 1 ELSE 0 END) +
       (CASE WHEN LOWER(E.Name) LIKE '%u%' THEN 1 ELSE 0 END)
      ) >= 4;
